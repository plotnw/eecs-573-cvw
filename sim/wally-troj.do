...
if {$2 eq "buildroot" || $2 eq "buildroot-checkpoint"} {
    ...
    vlog -lint -work wkdir/work_${1}_${2}_${3}_${4} +incdir+../config/$1 +incdir+../config/shared ../src/cvw.sv ../testbench/testbench-troj.sv ../testbench/common/*.sv   ../src/*/*.sv ../src/*/*/*.sv -suppress 2583 -suppress 7063,2596,13286  +define+RAM_LATENCY=$3 +define+BURST_EN=$4
    # start and run simulation
    ...
    vlog -lint -work wkdir/work_${1}_${3}_${4} +incdir+../config/$1 +incdir+../config/shared ../src/cvw.sv ../testbench/testbench-troj.sv ../testbench/common/*.sv   ../src/*/*.sv ../src/*/*/*.sv -suppress 2583 -suppress 7063,2596,13286 $5 $6 $7
    # start and run simulation
    # remove +acc flag for faster sim during regressions if there is no need to access internal signals
    vopt wkdir/work_${1}_${3}_${4}.testbench -work wkdir/work_${1}_${3}_${4} +acc -G TEST=$4 -o testbenchopt
    ...
    vlog -lint -work wkdir/work_${1}_${2} +incdir+../config/$1 +incdir+../config/shared ../src/cvw.sv ../testbench/testbench-troj.sv ../testbench/common/*.sv   ../src/*/*.sv ../src/*/*/*.sv -suppress 2583 -suppress 7063,2596,13286
    # start and run simulation
    # remove +acc flag for faster sim during regressions if there is no need to access internal signals
    if {$coverage} {
        vopt wkdir/work_${1}_${2}.testbench -work wkdir/work_${1}_${2} +acc -G TEST=$2 -o testbenchopt +cover=sbecf
        vsim -lib wkdir/work_${1}_${2} testbenchopt  -fatal 7 -suppress 3829 -coverage
    } else {
        vopt wkdir/work_${1}_${2}.testbench -work wkdir/work_${1}_${2} +acc -G TEST=$2 -o testbenchopt
